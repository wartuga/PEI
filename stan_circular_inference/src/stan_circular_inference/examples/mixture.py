...
mixture_statistics = service.get_mixture_statistics(values, real_values, inferred_labels, min_val=0, max_val=2*np.pi)
service.show_mixture_statistics(mixture_statistics)
